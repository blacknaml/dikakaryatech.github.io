...
- Banyak software-software untuk melakukan _probe_ dan penyusupan yang tersedia di internet dan bisa di-download secara gratis.
...
- eksploit lokal (_local exploit_),
- eksploit remote (_remote exploit_).
